    ...
    <div className="lg:hidden">
      ...
      {open ? (
        <div className="fixed inset-0 z-50 bg-brand-blue-dark/40 backdrop-blur-sm" role="presentation">
          <div className="ml-auto flex h-full w-full max-w-sm flex-col bg-white text-brand-blue-dark shadow-2xl" role="dialog" aria-modal="true" aria-label="Mobile navigation">
            ...
            <nav className="flex flex-col gap-1 bg-white p-4" aria-label="Mobile primary navigation">
