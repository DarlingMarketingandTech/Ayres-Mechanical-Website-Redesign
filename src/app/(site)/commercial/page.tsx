    ...
    <>
      <PageHero
        ...
        heroActions={{
          ...
          secondary: { href: routes.commercialMaintenancePlans, label: "View Commercial Maintenance Plans" },
        }}
      />
      ...
      <Section>
        <Container className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.85fr)] lg:items-center">
          <div>
            ...
            <h2 className="mt-3 text-(length:--text-section) font-black text-balance text-brand-blue-dark">
              Commercial maintenance planning fits buildings that need fewer surprises.
            </h2>
